...
class TestAdminProfileTranslator():
    def setup_method(self):
        self.translator = AdminProfileTranslator()
...
class TestCommunitySocialWorkerProfileTranslator():
    def setup_method(self):
        self.translator = CommunitySocialWorkerProfileTranslator()
...
class TestPublicOfficialProfileTranslator():
    def setup_method(self):
        self.translator = PublicOfficialProfileTranslator()
