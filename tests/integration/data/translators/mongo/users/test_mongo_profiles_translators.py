...
class TestMongoAdminProfileTranslator():
    def setup_method(self):
        self.translator = structure.mongo_admin_profile_translator
...
class TestMongoCommunitySocialWorkerProfileTranslator():
    def setup_method(self):
        self.translator = structure.mongo_community_social_worker_profile_translator
...
class TestPublicOfficialWorkerProfileTranslator():
    def setup_method(self):
        self.translator = structure.mongo_public_official_profile_translator
